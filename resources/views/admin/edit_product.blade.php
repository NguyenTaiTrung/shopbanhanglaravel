                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$pro->product_price}}" name="product_price" data-validation="length" data-validation-length="min5" data-validation-error-msg="Làm ơn điền số tiền" class="form-control price_format" >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Giá gốc</label>
                                    <input type="text" value="{{$pro->price_cost}}" data-validation="length" data-validation-length="min5" data-validation-error-msg="Làm ơn điền số tiền" name="price_cost" class="form-control price_format" id="" placeholder="Tên danh mục">
                                </div>
                                  <div class="form-group">
