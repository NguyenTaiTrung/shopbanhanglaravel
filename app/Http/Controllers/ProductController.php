   ...
   public function AuthLogin(){
    ...
    public function details_product($product_slug , Request $request){
       ...
       //update views 
        ...
        $rating = round($rating);
        return view('pages.sanpham.show_details')->with('category',$cate_product)->with('brand',$brand_product)->with('product_details',$details_product)->with('relate',$related_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('slider',$slider)->with('category_post',$category_post)->with('gallery',$gallery)->with('product_cate',$product_cate)->with('cate_slug',$cate_slug)->with('rating',$rating);
    ...
    public function reply_comment(Request $request){
        ...
        $comment->comment_name = 'dodientu.store';
        $comment->save();
            ...
            <div class="row style_comment">
                                    ...
                                    foreach($comment_rep as $key => $rep_comment)  {
                                     ...
                                     $output.= ' <div class="row style_comment" style="margin:5px 40px;background: aquamarine;">
                                        ...
                                        <div class="col-md-2">
                                            <img width="80%" src="'.url('/public/frontend/images/businessman.jfif').'" class="img img-responsive img-thumbnail">
                                        </div>
                                        <div class="col-md-10">
